...
HTML 요소는 non-semantic 요소, semantic 요소로 구분할 수 있습다.

| non-semantic 요소 | div, span 등이 있으며 이들 태그는 content에 대하여 어떤 설명도 하지 않습다. |
| --- | --- |
| semantic-요 |  form, table, img 등이 있으며 이들 태그는 content의 의미를 명확히 설명합다. |
